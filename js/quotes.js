let quotes = [
    ...
    {
        quote: "옳고 그름 사이에 당신들이 있소\n정의의 저울이 기울어질 때도 있습니다\n불균형을 감당하는 법을 배워야겠지요\n이중에 살인자는 없습니다\n치유가 필요한 사람들만 있을뿐",
        author:"\n-오리엔트 특급 살인사건 [비폭력적인 긴장감]"
    },
    {
        quote: "지리학을 무섭게 가르치죠\n인생에서 길을 잃어도 거기가 어디쯤인지는 알아야 하니까",
        author:"\n-오리엔트 특급 살인사건 [비폭력적인 긴장감]"
    },
    {
        quote: "아무런 편견 없이 사실들을 관찰한 후\n포물선의 경로를 밝혀내고\n종착점으로 유유히 가보면\n진실이 내 발 앞에 떨어집니다.",
        author:"\n-나이브스 아웃 [비폭력적인 긴장감]"
    },
    {
        quote: "초등학교 시절에 다른 아이들은 나에게 이야기를 지어달라고 부탁하기가 일쑤였다.\n그러면 나는 대개 이런 식으로 시작하는 이야기를 들려주었다.\n<그는 아무 생각 없이 문을 열었다가 너무 놀라서 입을 다물지 못했어..>\n세월이 흐르면서 그 이야기들은 갈수록 환상적인 것으로 변했다.\n그러다가 그것들은 하나의 게임이 되었다.\n사람들에게 어떤 문제를 제기하고 뜻밖의 해결을 찾아내게 하는 게임 말이다.",
        author:"\n-나무 [상상력]"
    },
    {
        quote: "지식을 탐구하기 위해 공인된 과학자가 될 필요는 없다.\n그저 자유롭다는 것만으로도 자격은 충분하다.\n무릇 학문이란 자유의 행위여야 한다고 그는 생각했다.\n미리 짜놓은 틀이나 숭배의 대상이나 지배자나 선입견에 속박되지 않고\n스스로 생각하는 자유, 그런 자유가 보장될 때 학문은 비로소 존재하게 된다.",
        author:"\n-나무 [상상력]"
    },
    {
        quote: "자기 안에 쓰레기 없는 사람이 어디 있어요? \n 아마 그래서 사람들은 착하고 이쁜 거만 보고 싶은가봐요\n자기 안에 쓰레기 안 보려고. \n그리고 드러운 거 보면 토하고. \n 근데 나는 내 쓰레기도 보고, 복수 씨 쓰레기도 볼래요.\n나 비위 강하거든요. 토하고 그러지 않아요",
        author:"\n-네멋대로해라 [사랑에 대한 본질]"
    },
    {
