let quotes = [
    ...
    {
        quote: "초등학교 시절에 다른 아이들은 \n나에게 이야기를 지어달라고 부탁하기가 일쑤였다.\n그러면 나는 대개 \n이런 식으로 시작하는 이야기를 들려주었다.\n\n<그는 아무 생각 없이 문을 열었다가 \n너무 놀라서 입을 다물지 못했어..>\n\n세월이 흐르면서 그 이야기들은 \n갈수록 환상적인 것으로 변했다.\n그러다가 그것들은 하나의 게임이 되었다.\n사람들에게 어떤 문제를 제기하고 \n뜻밖의 해결을 찾아내게 하는 게임 말이다.",
        author:"\n-나무 [상상력]"
    },
    {
        quote: "지식을 탐구하기 위해 \n공인된 과학자가 될 필요는 없다.\n그저 자유롭다는 것만으로도 자격은 충분하다.\n\n무릇 학문이란 \n자유의 행위여야 한다고 그는 생각했다.\n미리 짜놓은 틀이나 숭배의 대상이나\n 지배자나 선입견에 속박되지 않고\n스스로 생각하는 자유, \n그런 자유가 보장될 때 학문은 비로소 존재하게 된다.",
        author:"\n-나무 [상상력]"
    },
    {
